...
const Map<String, String> en = {
  ...
  Lang.homeViewBlance: 'Blance(CGB)',
  Lang.homeViewSelling: 'Selling(CGB)',
  Lang.homeViewLock: 'Lock(CGB)',
  Lang.homeViewWalletAddress: 'Wallet address',
  Lang.homeViewBuyCoin: 'Buy',
  Lang.homeViewSellCoin: 'Sell',
  Lang.homeViewTrastion: 'Trastion',
